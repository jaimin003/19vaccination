<%@ Page Title="" Language="C#" MasterPageFile="~/hospital/Hmaster.master" AutoEventWireup="true" CodeFile="addvacc.aspx.cs" Inherits="hospital_Default" %>
						...
						<div class="col-xl-12 col-lg-6 col-md-12 col-sm-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Enter Vaccine Information</div>
								</div>
								<div class="card-body">
									<div class="row gutters">
										...
										<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											<div class="form-group">
                                                ...
                                                <asp:DropDownList ID="ddlage" runat="server" class="form-control">
                                                    <asp:ListItem value="15">AGE 15-18 YEAR</asp:ListItem>
                                                    <asp:ListItem value="18">AGE 18 YEAR ABOVE</asp:ListItem>
                                                    <asp:ListItem value="35">AGE 35 YEAR ABOVE</asp:ListItem>
                                                    <asp:ListItem value="55">AGE 55 YEAR ABOVE</asp:ListItem>
                                                </asp:DropDownList>
											</div>
										</div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											<div class="form-group">
                                                ...
                                                <asp:TextBox ID="txttotvac" runat="server" class="form-control" placeholder="Enter total vaccine stock"></asp:TextBox>
										...
										<div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-7">
											<div class="text-right">
                                                ...
                                                <asp:Button ID="btn_submit" runat="server" class="btn btn-primary" 
                                                    Text="Add Vaccine Data" onclick="btn_submit_Click" />
											</div>
										</div>
									</div>
								</div>
