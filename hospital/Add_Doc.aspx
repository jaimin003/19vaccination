<%@ Page Title="" Language="C#" MasterPageFile="~/hospital/Hmaster.master" AutoEventWireup="true" CodeFile="Add_Doc.aspx.cs" Inherits="hospital_Default" %>
									...
									<div class="row gutters">
										...
										<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											<div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtmail" runat="server" class="form-control" placeholder="Enter Doctor Email"> </asp:TextBox>
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                                                    ErrorMessage="Invaid Email*" ControlToValidate="txtmail" ForeColor="Red" 
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											<div class="form-group">
                                              ...
                                              ForeColor="Red"      ErrorMessage="Plzz Enter Contact Number*" ControlToValidate="txtphno"></asp:RequiredFieldValidator>
											</div>
										</div>

									   <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											<div class="form-group">
												<label for="inputSpeciality">Enter Your Fees</label>
												<%--<input type="text" class="form-control" id="Text2" placeholder="Contact number">--%>
                                                <asp:TextBox ID="txtfees" runat="server" class="form-control" placeholder="Enter Fees"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                                                    ForeColor="Red" ErrorMessage="Plzz Enter Your Fees*" ControlToValidate="txtfees"></asp:RequiredFieldValidator>
											</div>
										</div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											<div class="form-group">
												<label for="inputSpeciality">Select Vaccine Center</label>
												<%--<input type="text" class="form-control" id="Text2" placeholder="Contact number">--%>
                                                <asp:DropDownList ID="ddlvcenter" class="form-control" runat="server" 
										...
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
											<div class="text-center">
                                                ...
                                                <asp:Button ID="btn_submit" runat="server" class="btn btn-primary" 
                                                    Text="Add Doctor" onclick="btn_submit_Click" />
											</div>
										</div>
									</div>
								</div>
