<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Suc.aspx.cs" Inherits="payment_suc" %>
...
<!-- Mirrored from demo.harnishdesign.net/html/payyed/send-money-success.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 May 2021 12:45:21 GMT -->
<head>
<meta charset="UTF-8" />
...
<div id="main-wrapper"> 
 <div id="Div1"> 
   <br/>
   <br/>
<h2 class="text-success text-center display-4">SUCCESSFULL PAYMENT</h2><br /> 
  <!-- Secondary menu
  ============================================= -->
  <!-- Secondary menu end --> 
  ...
  <div id="content" class="py-4">
    <div class="container"> 
      ...
      <h2 class="font-weight-400 text-center mt-3 mb-4">Payment Successsfull</h2>
      <div class="row">
        <div class="col-md-9 col-lg-7 col-xl-6 mx-auto"> 
          ...
          <div class="bg-white text-center shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4">
            <div class="my-4">
              ...
              <p class="text-success text-8 font-weight-500 line-height-07">Successfull!</p>
              <p class="lead">Transactions Complete</p>
            </div>
            <p class="text-3 mb-4">You've Succesfully Paid <span class="text-4 font-weight-500">
                <asp:Label ID="lblp" runat="server" Text="Label"></asp:Label></span> to <span class="font-weight-500">
                    <asp:Label ID="lblhname" runat="server" Text="Label"></asp:Label></span>, See transaction details under <a class="btn-link" href="#">Activity</a>.</p>
            <button class="btn btn-primary btn-block">Thank You!!</button>
            <a class="text-3 d-inline-block btn-link mt-4" href="../UserCovid/dummyinvoice.aspx"><i class="fas fa-print"></i> Print</a><br />
            <a class="btn-link" href="../user/Uhome.aspx"><-Go To Home</a> </div>
        </div>
      </div>
    </div>
  </div>
