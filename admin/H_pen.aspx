<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Amaster.master" AutoEventWireup="true" CodeFile="H_pen.aspx.cs" Inherits="admin_Default" %>
   ...
   <div class="container-fluid">
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between">
                            <h5 class="mb-0">Hospital Pending List</h5>
                                    ...
                                    <table class="table table-center bg-white mb-0">
                                        <thead>
                                            <tr>                                                                                                
                                                ...
                                                <th class="text-center py-2 border-bottom">Action</th>
