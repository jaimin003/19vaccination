<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Amaster.master" AutoEventWireup="true" CodeFile="H_list.aspx.cs" Inherits="admin_Default" %>
                                ...
                                <div class="table-responsive shadow rounded">
                                   ...
                                   <HeaderTemplate>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                        ...
                                        SelectCommand="SELECT * FROM [hosp_reg]"></asp:SqlDataSource>
