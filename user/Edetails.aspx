<%@ Page Title="" Language="C#" MasterPageFile="~/user/Umaster.master" AutoEventWireup="true" CodeFile="Edetails.aspx.cs" Inherits="user_Default" %>
...
<h1 class="text-custom-white">Events Details</h1>
<ul class="custom-flex">
<li>
<a href="index.html" class="text-custom-white">Home</a>
</li>
<li>
<a href="blog.html" class="text-custom-white">Events</a>
</li>
...
<h2 class="post-title"><a href="#" class="text-custom-black">THIS EVENTS ARE OCCURS IN OUR HOSPITALS</a></h2>
...
EVENT &nbsp NAME &nbsp&nbsp&nbsp<asp:Label ID="Label2" runat="server" Text="Label"  ForeColor="Black"></asp:Label><br />
...
<h3 class="text-custom-black fw-600">Listing Of Events</h3>
...
<cite>
<a href="Edetails.aspx?ename=<%#Eval("ename") %>&img=<%#Eval("img") %>&dis=<%#Eval("dis") %>&hname=<%#Eval("hospital") %>" class="text-custom-black fw-500 fs-14"><%#Eval("ename") %></a>
</cite>
</div>
