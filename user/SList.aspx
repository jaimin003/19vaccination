<%@ Page Title="" Language="C#" MasterPageFile="~/user/Umaster.master" AutoEventWireup="true" CodeFile="SList.aspx.cs" Inherits="user_Default" %>
...
<h1 class="text-custom-white">Services</h1>
...
<a href="Sdetails.aspx?sname=<%#Eval("servicename") %>&img=<%#Eval("img") %>&dis=<%#Eval("dis") %>&hname=<%#Eval("hospital") %>">
...
<cite>
<a href="blog-details.html" class="text-custom-black fw-500 fs-14"><%#Eval("servicename") %></a>
</cite>
</div>
