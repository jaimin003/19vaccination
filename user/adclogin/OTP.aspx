<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OTP.aspx.cs" Inherits="ExtraCovid_OTP" %>
...
<asp:TextBox ID="txtotp" runat="server" class="form-control input-lg" placeholder="Enter your OTP" TextMode="Password"></asp:TextBox>
<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ErrorMessage="Plzz Enter OTP" ControlToValidate="txtotp" ForeColor="Red"></asp:RequiredFieldValidator>
</div>

<div class="form-group last">
<%--<button type="submit" class="btn btn-success btn-block btn-lg">Sign In</button>--%>
<asp:Button ID="Btn_validate" runat="server" Text="Validate" 
        class="btn btn-primary btn-block btn-lg" onclick="Btn_validate_Click" ></asp:Button>
