<%@ Page Title="" Language="C#" MasterPageFile="~/user/Umaster.master" AutoEventWireup="true" CodeFile="View_certi.aspx.cs" Inherits="user_Default" %>
...
<form id="form1" runat="server">
        ...
        <section class="bg-half-170 bg-light">
            ...
            <br />
            <br />
            <center> <h1 class="text-theme  font-weight-bolder font">Certificate for coivd-19 vaccination</h1></center>
                                ...
                                <div class="col-lg-4 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="d-flex mt-2">
                                            <small class="mb-0 text-black"  style="font-weight: bolder; font-size: medium;">Email : </small>
                                            <small class="mb-0">&nbsp;&nbsp;<a href="mailto:contact@example.com" class="text-black"><asp:Label  ID="lblmail" runat="server" Text="Label" Font-Size="Medium" Font-Bold="True"></asp:Label></a></small>
                                        </li>
                                        <li class="d-flex mt-2">
                                            <small class="mb-0 text-muted" style="font-weight: bolder; font-size: medium;">Phone : </small>
                                            <small class="text-black"><a href="javascript:void(0)" class="text-black"><asp:Label ID="lblphno" runat="server" Text="Label" Font-Size="Medium" Font-Bold="True"></asp:Label></a></small>
                                        </li>
                                        <li class="d-flex mt-2">
                                        <small class="mb-0 text-black" style="font-weight: bolder; font-size: medium;">Name : </small>
                                            <small class="mb-0 text-black"><a href="javascript:void(0)" class="text-black"><asp:Label ID="lblpname" runat="server" Text="Label" Font-Size="Medium" Font-Bold="True"></asp:Label></a></small>
                                            
                                        </li>
                                        <li class="d-flex mt-2">
                                            <small class="text-black" style="font-weight: bolder; font-size: medium;">Age : </small>
                                            <small class="mb-0">&nbsp;&nbsp;<a href="javascript:void(0)" class="text-black"><asp:Label ID="lblage" runat="server" Text="Label" Font-Size="Medium" Font-Bold="True"></asp:Label></a></small>
                                        </li>
                                        <li class="d-flex mt-2">
                                            <small class="mb-0 text-muted" style="font-weight: bolder; font-size: medium;">Website : </small>
                                            <small class="mb-0" style="font-weight: bolder; font-size: medium;">&nbsp;&nbsp;<a href="javascript:void(0)" class="text-black">www.proj.com</a></small>
                                        </li>
